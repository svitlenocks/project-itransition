...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post benefits_url, params: { benefit: { compaign_id: @benefit.compaign_id, description: @benefit.description, sum: @benefit.sum, title: @benefit.title } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { compaign_id: @benefit.compaign_id, description: @benefit.description, sum: @benefit.sum, title: @benefit.title } }
